...
const BigCard = ({ bgColor, textColor, sub, title, title2, cardimg, width, right, mdwidth, top, category }) => {
  ...
  return (
    <div className='w-[173px] md:w-[600px] flex mb-6 md:mb-10 justify-center items-center poppins-regular'>
      <div className={`flex ${bgColor} ${textColor} w-[95%] m-auto rounded-3xl relative h-[137px] md:h-[300px] shadow-xl`}>
