            ...
            {SliderData.map(item => {
                return (
                    <div className='flex' key={item.id}>
                        <div className='flex flex-row bg-gradient-to-r from-gray-400 to-gray-100 w-[97%] mx-auto rounded-3xl md:mt-2 mt-0 justify-around h-[120px] md:h-[280px]'>
                            {/* For heading */}
                            ...
                            {/* For images */}
                            <div className='flex'>
                                <img className='h-[85%] md:h-[80%] w-[150px] md:w-[350px] m-auto ' src={item.img} alt="Images"  height={250} />
                            </div>
                        </div>
                    </div>
                );
